    ...
    synchronized int decodevs_add(float[] a, int offset, Buffer b, int n) {
        ...
        while (i < this.dim) {
            for (int j = 0; j < step; ++j) {
                float[] arrf = a;
                int n2 = offset + o + j;
                arrf[n2] = arrf[n2] + this.valuelist[this.t[j] + i];
            }
            ++i;
            o += step;
        }
        ...
        if (this.dim > 8) {
            ...
            while (i < n) {
                ...
                while (j < this.dim) {
                    float[] arrf = a;
                    int n2 = offset + i++;
                    arrf[n2] = arrf[n2] + this.valuelist[t + j++];
                }
            }
        } else {
            int i = 0;
            while (i < n) {
                ...
                switch (this.dim) {
                    case 8: {
                        float[] arrf = a;
                        int n3 = offset + i++;
                        arrf[n3] = arrf[n3] + this.valuelist[t + j++];
                    }
                    case 7: {
                        float[] arrf = a;
                        int n4 = offset + i++;
                        arrf[n4] = arrf[n4] + this.valuelist[t + j++];
                    }
                    case 6: {
                        float[] arrf = a;
                        int n5 = offset + i++;
                        arrf[n5] = arrf[n5] + this.valuelist[t + j++];
                    }
                    case 5: {
                        float[] arrf = a;
                        int n6 = offset + i++;
                        arrf[n6] = arrf[n6] + this.valuelist[t + j++];
                    }
                    case 4: {
                        float[] arrf = a;
                        int n7 = offset + i++;
                        arrf[n7] = arrf[n7] + this.valuelist[t + j++];
                    }
                    case 3: {
                        float[] arrf = a;
                        int n8 = offset + i++;
                        arrf[n8] = arrf[n8] + this.valuelist[t + j++];
                    }
                    case 2: {
                        float[] arrf = a;
                        int n9 = offset + i++;
                        arrf[n9] = arrf[n9] + this.valuelist[t + j++];
                    }
                    case 1: {
                        float[] arrf = a;
                        int n10 = offset + i++;
                        arrf[n10] = arrf[n10] + this.valuelist[t + j++];
                    }
                }
            }
        }
        ...
        switch (addmul) {
            ...
            case 0: {
                ...
                while (i < this.dim) {
                    float[] arrf = a;
                    int n = index + o;
                    arrf[n] = arrf[n] + this.valuelist[entry * this.dim + i];
                    ++i;
                    o += step;
                }
                break;
        ...
        switch (addmul) {
            case 0: {
                ...
                while (i < this.dim) {
                    float[] arrf = a;
                    int n = o;
                    arrf[n] = arrf[n] - this.valuelist[best * this.dim + i];
                    ++i;
                    o += step;
                }
                break;
